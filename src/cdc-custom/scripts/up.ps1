...
Write-Host ""
Write-Host "── 기동 완료 ─────────────────────────────────────"
Write-Host "  source DB   : localhost:58432 (sourcedb / postgres:postgres)"
Write-Host "  target DB   : localhost:58433 (targetdb / postgres:postgres)"
Write-Host "  sync-service: http://localhost:58280/actuator/health"
Write-Host "  Prometheus  : http://localhost:58290"
Write-Host "  Grafana     : http://localhost:58300  (admin/admin)"
